...
export no_proxy="127.0.0.1,localhost,::1,${no_proxy:-}"
export WEBSHOP_CRITIC_JUDGE_MAX_WORKERS="${WEBSHOP_CRITIC_JUDGE_MAX_WORKERS:-32}"
export WEBSHOP_CRITIC_JUDGE_MAX_CONCURRENCY="${WEBSHOP_CRITIC_JUDGE_MAX_CONCURRENCY:-32}"

python -u open_instruct/grpo_fast.py \
  --exp_name webshop-agentgym-critic-v5-8192 \
  ...
  --dataset_local_cache_dir /home/u2021110842/super-auto-rubric/artifacts/webshop_tulu/formal_v5_agentgym/cache_critic_8192 \
  ...
  --critic_error_pool_path /home/u2021110842/super-auto-rubric/artifacts/webshop_tulu/formal_v5_agentgym/critic_error_pool_8192.jsonl \
  --critic_error_update_every_steps 64 \
  --critic_error_inject_every_steps 32 \
  --critic_error_retire_after_absent_batches 3 \
  --critic_error_judge_model kimi-k2.6 \
  --critic_error_openai_base_url https://ark.cn-beijing.volces.com/api/plan/v3 \
  --critic_error_api_key_env SEED_AGENT_PLAN_API_KEY \
  --critic_error_max_active_weaknesses 8 \
  --critic_error_trigger_threshold 0.55 \
  ...
  --pack_length 2304 \
  --temperature 0.8 \
  --webshop_rollout_trace_path /home/u2021110842/super-auto-rubric/artifacts/webshop_tulu/formal_v5_agentgym/critic_v5_rollout_trace.jsonl \
  --num_evals 0 \
  --save_freq 128 \
  --async_mode False \
  --deepspeed_stage 3 \
  ...
  --output_dir /home/u2021110842/super-auto-rubric/outputs/formal_v5_agentgym/webshop-critic-8192 \
  --seed 5
